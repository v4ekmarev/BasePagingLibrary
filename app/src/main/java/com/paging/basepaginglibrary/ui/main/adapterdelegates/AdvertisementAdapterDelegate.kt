...
class AdvertisementAdapterDelegate : AdapterDelegate<List<DisplayableItem>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, inflater: LayoutInflater): RecyclerView.ViewHolder {
        return AdvertisementViewHolder(inflater.inflate(R.layout.item_advertisement, parent, false))
    }
     ...
     * The ViewHolder
     */
    internal class AdvertisementViewHolder(itemView: View?) : RecyclerView.ViewHolder(
        itemView!!
    )
